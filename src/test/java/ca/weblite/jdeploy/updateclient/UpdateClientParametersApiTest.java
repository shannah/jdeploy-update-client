...
/**
 * Verifies the parameters-based API can be exercised in headless mode and that
 * preference-based gating (ignored version) prevents further work without touching
 * filesystem or network. The test simply ensures no exceptions are thrown.
 */
