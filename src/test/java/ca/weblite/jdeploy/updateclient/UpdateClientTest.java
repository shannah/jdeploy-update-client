...
public class UpdateClientTest {
  ...
  public void testCompareVersionNumericOrdering() throws Exception {
    ...
    Method compare =
        UpdateClient.class.getDeclaredMethod("compareVersion", String.class, String.class);
  ...
  public void testExtractFilenameFromHeader() throws Exception {
    UpdateClient client = new UpdateClient();
    Method extract =
        UpdateClient.class.getDeclaredMethod("extractFilenameFromHeader", String.class);
  ...
  public void testDetectPlatformAndConstructURL_Windows() throws Exception {
    ...
    Method constructUrl =
        UpdateClient.class.getDeclaredMethod(
            "constructInstallerDownloadURL", String.class, String.class, String.class);
    constructUrl.setAccessible(true);

    String url =
        (String) constructUrl.invoke(client, "mypkg", "1.2.3", "https://github.com/owner/repo");
    assertNotNull(url);
