...
public class UpdateClientLauncherVersionTest {
    ...
    @Test
    public void testRequireVersionReturnsWhenAppVersionPropertyMissing() {
        System.clearProperty("jdeploy.app.version");
        System.clearProperty("jdeploy.launcher.app.version");
    ...
    @Test
    public void testUsesLauncherVersionOverParamsCurrentVersion() {
    ...
    @Test
    public void testBranchLauncherVersionSkipsPrompt() {
        System.setProperty("jdeploy.app.version", "1.2.3");
